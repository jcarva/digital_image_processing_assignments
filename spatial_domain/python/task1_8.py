...
def main():
    ...
    sobel_y_image = filter.apply_kernel(image, [[1, 2, 1], [0, 0, 0], [-1, -2, -1]])
    sobel_x_image = filter.apply_kernel(image, [[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]])
    ...
    utils.display_multiple_images(['Sobel_Y Lenna', 'Sobel_X Lenna', 'Sobel X + Y', 'Laplacian Lenna'],
                                  [sobel_y_image, sobel_x_image, sobel_addition, laplacian_image])
